...
public class RedstoneWallTorchNode extends Node
{
    // ### Fields
    ...
    public RedstoneWallTorchNode(World world, BlockPos position, BlockState blockState)
    {
    ...
    public void populateChildren()
    {
        ...
        Direction torchFacing = this.blockState.get(Properties.HORIZONTAL_FACING);
